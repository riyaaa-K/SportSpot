...
<section class="cricket-hero">
    <h1>Make a Reservation For Cricket</h1>
</section>
<section class="ground">
    <h1>Our Features</h1>
    <p>Everything you need for a seamless cricket booking experience.</p>
...
<section class="gallery">
    <h1>Our Gallery</h1>
    <p>Explore our cricket grounds and facilities.</p>
    <div class="gallery-row">

        <!-- Visible Images -->
        <div class="gallery-col"><img src="images/1.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/8.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/3.jpg" onclick="openLightbox(this.src)"></div>
...
<section class="details">
    ...
    <p>Everything you need to know about our cricket facilities.</p>
...
<h4>MAKE A RESERVATION</h4>
    <h2>Book Your Cricket Ground Easily</h2>
