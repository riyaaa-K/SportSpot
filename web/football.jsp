...
<section class="Football-hero">
    <h1>Make a Reservation For Football</h1>
</section>
<section class="ground">
    <h1>Our Features</h1>
    <p>Everything you need for a seamless Football booking experience.</p>
...
<section class="gallery">
    <h1>Our Gallery</h1>
    <p>Explore our Football grounds and facilities.</p>
    <div class="gallery-row">

        <!-- Visible Images -->
        <div class="gallery-col"><img src="images/56.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/f2.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/f3.jpg" onclick="openLightbox(this.src)"></div>

        <!-- Hidden Images -->
        <div class="gallery-col hidden"><img src="images/f4.jpg" onclick="openLightbox(this.src)"></div>
...
<section class="details">
    ...
    <p>Everything you need to know about our Football facilities.</p>
...
<h4>MAKE A RESERVATION</h4>
    <h2>Book Your Football Ground Easily</h2>
