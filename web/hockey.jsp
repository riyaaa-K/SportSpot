...
<section class="cricket-hero">
    <h1>Make a Reservation For Hockey</h1>
</section>
<section class="ground">
    <h1>Our Features</h1>
    <p>Everything you need for a seamless Hockey booking experience.</p>
...
<section class="gallery">
    <h1>Our Gallery</h1>
    <p>Explore our Hockey grounds and facilities.</p>
    <div class="gallery-row">

        <!-- Visible Images -->
        <div class="gallery-col"><img src="images/hc.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/ho_1.jpg" onclick="openLightbox(this.src)"></div>
        <div class="gallery-col"><img src="images/hy.jpg" onclick="openLightbox(this.src)"></div>

        <!-- Hidden Images -->
        <div class="gallery-col hidden"><img src="images/hu.jpg" onclick="openLightbox(this.src)"></div>
...
<section class="details">
    ...
    <p>Everything you need to know about our Hockey facilities.</p>
...
<h4>MAKE A RESERVATION</h4>
    <h2>Book Your Hockey Ground Easily</h2>
